...
export function FeedbackSuccessStep({onRestartRequest}:FeedbackSuccessStepProps){
    return (
        <>
            <div className=" flex flex-col items-center py-10 w-[304px]">
                ...
                <button
                    ...
                    type="button" 
                    className="px-2 py-2 mt-6 bg-zinc-800 rounded border-transparent text-sm leading-6  hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500">
                    Quero enviar outro!
                </button>
